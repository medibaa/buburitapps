  ...
  return (
    <Container>
      <Snk>
        ...
        b. Pembayaran harus dilakukan sesuai dengan metode pembayaran yang telah ditentukan.
        ...
        a. Kami menerima pengembalian dan penukaran produk jika terdapat cacat atau kerusakan pada saat pengiriman.
        b. Harap memberikan laporan dan bukti yang jelas dalam waktu 24 jam setelah menerima produk yang bermasalah.
        c. Pengembalian atau penukaran hanya dapat dilakukan jika produk masih dalam kondisi asli dan tidak digunakan.

        Privasi dan Keamanan
        a. Kami akan melindungi informasi pribadi Anda sesuai dengan kebijakan privasi yang telah ditetapkan.
        b. Anda bertanggung jawab untuk menjaga kerahasiaan akun Anda dan tidak mengungkapkan informasi login kepada pihak ketiga.

        Perubahan Syarat dan Ketentuan
        a. Kami berhak mengubah syarat dan ketentuan ini dari waktu ke waktu. Perubahan tersebut akan efektif setelah diberlakukan.
        b. Kami akan memberi tahu Anda tentang perubahan melalui pemberitahuan di situs web atau melalui kontak yang telah Anda berikan kepada kami.

        Harap dicatat bahwa syarat dan ketentuan ini dapat berbeda tergantung pada wilayah hukum Anda. Dengan menggunakan layanan kami, Anda setuju untuk tunduk pada hukum yang berlaku.

        Terima kasih telah menggunakan Blunet. Jika Anda memiliki pertanyaan atau kekhawatiran tentang syarat dan ketentuan ini, jangan ragu untuk menghubungi tim dukungan kami.
